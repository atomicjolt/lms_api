...
def lms_headers(options = {})
  {
    ...
    "server" => ["Apache"],
    "set-cookie" => ["_csrf_token=9ATKDp5mkAhXm5DTVw54PeMj0FoKrA%2BUNQnFEfXgUs6eL4cl5hXEZwL5xoM%2FdhlS2xWAMT%2BHQs1iRLYkv9YTtg%3D%3D; path=/; secure", "lms_session=LxC99e7zSpIBWuoSrxCHdg.xTKVNyuNeaLj864o1zvSA2YTzFQTPbQNpYoi2ktpSRSfjl0Q7CQe7W543_0So0FLILT3TkPbbGjcfoRGZNBhdWw8iOr7QRrIFwTHFdLNE7DWMRM4ZhX16kNxCI0_OD7g.iGFa_i2CresH7XxNz2ZwUksLtOk.VQiVgw; path=/; secure; HttpOnly"],
    "status" => ["200"],
  ...
  config.before(:each) do
    ...
    stub_request(:get, %r|http[s]*://[a-zA-Z0-9]+\.[a-zA-Z0-9]+.com/api/v1/courses|).
      to_return(
        ...
        body: lms_courses,
        headers: lms_headers(
          "link" => %Q{<https://next-courses.instructure.com/api/v1/courses.json?opaqueA>; rel="current",<https://next-courses.instructure.com/api/v1/courses.json?opaqueB>; rel="next",<https://next-courses.instructure.com/api/v1/courses.json?opaqueC>; rel="first",<https://next-courses.instructure.com/api/v1/courses.json?opaqueD>; rel="last"})
      )
    ...
    ["accounts", "courses"].each do |kind|
      lms_external_tool_url = %r|http[s]*://[a-zA-Z0-9]+\.[a-zA-Z0-9]+.*com/api/v1/#{kind}/.+/external_tools|

      stub_request(:get, lms_external_tool_url).
        to_return(
          status: 200,
      ...
      stub_request(:post, lms_external_tool_url).
        to_return(
          status: 200,
          body: lti_tool_json,
          headers: lms_headers
      ...
      stub_request(:put, lms_external_tool_url).
        to_return(
          status: 200,
          body: lti_tool_json,
          headers: lms_headers
