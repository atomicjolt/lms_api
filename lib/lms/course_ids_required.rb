module LMS
  COURSE_REQUIRED_ENDPOINTS = [
    ...
    "LIST_GROUP_MEMBERS_FOR_STUDENT_ON_ASSIGNMENT",
    ...
    "SUMMARY_COURSES",
    "DISABLE_SUMMARY_COURSES",
    "SUMMARY_FEEDBACK_COURSES",
    ...
    "MARK_ALL_TOPIC_AS_READ_COURSES",
    ...
    "BATCH_UPDATE_GRADING_PERIODS_COURSES",
    ...
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_MODULES",
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_ASSIGNMENTS",
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_QUIZZES",
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_DISCUSSION_TOPICS",
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_PAGES",
    "GET_LEARNING_OBJECT_S_DATE_INFORMATION_FILES",
    "UPDATE_LEARNING_OBJECT_S_DATE_INFORMATION_ASSIGNMENTS",
    "UPDATE_LEARNING_OBJECT_S_DATE_INFORMATION_QUIZZES",
    "UPDATE_LEARNING_OBJECT_S_DATE_INFORMATION_DISCUSSION_TOPICS",
    "UPDATE_LEARNING_OBJECT_S_DATE_INFORMATION_PAGES",
    "UPDATE_LEARNING_OBJECT_S_DATE_INFORMATION_FILES",
    "CREATE_LINE_ITEM",
    "UPDATE_LINE_ITEM",
    "SHOW_LINE_ITEM",
    "LIST_LINE_ITEMS",
    ...
    "SHOW_LTI_RESOURCE_LINK",
    "CREATE_LTI_RESOURCE_LINK",
    "BULK_CREATE_LTI_RESOURCE_LINKS",
    "UPDATE_LTI_RESOURCE_LINK",
    "DELETE_LTI_RESOURCE_LINK",
    "LIST_MEDIA_OBJECTS_COURSES_MEDIA_OBJECTS",
    "LIST_MEDIA_OBJECTS_COURSES_MEDIA_ATTACHMENTS",
    ...
    "LIST_MODULE_S_OVERRIDES",
    "UPDATE_MODULE_S_OVERRIDES",
    ...
    "QUIZ_REPORTS_CREATE_QUIZ_REPORT",
    "GET_QUIZ_REPORT",
    ...
    "GET_COURSES_AND_ASSIGNMENTS_FOR_COURSES",
    "CREATES_RUBRIC_USING_CSV_FILE_COURSES",
    "GET_STATUS_OF_RUBRIC_IMPORT_COURSES",
    ...
    "MARK_BULK_SUBMISSIONS_AS_READ_COURSES",
    "MARK_SUBMISSION_ITEM_AS_READ_COURSES",
    "CLEAR_UNREAD_STATUS_FOR_ALL_SUBMISSIONS_COURSES",
