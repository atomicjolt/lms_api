    ...
    module Types
      module Canvas
        class Section < BaseType
          ...
          field :sis_section_id, ID, "The sis id of the section. This field is only included if the user has permission to view SIS information..Example: s34643", null: true
          field :integration_id, ID, "Optional: The integration ID of the section. This field is only included if the user has permission to view SIS information..Example: 3452342345", null: true
