    ...
    module Types
      module Canvas
        ...
        class FeatureFlag < BaseType
          ...
          field :context_id, Int, "The id of the object to which this flag applies (This field is not present if this FeatureFlag represents the global Canvas default).Example: 1038", null: true
