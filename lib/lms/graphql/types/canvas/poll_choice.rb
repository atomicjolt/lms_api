    ...
    module Types
      module Canvas
        class PollChoice < BaseType
          ...
          field :id, Int, "The unique identifier for the poll choice..Example: 1023", null: true
          field :poll_id, Int, "The id of the poll this poll choice belongs to..Example: 1779", null: true
