    ...
    module Types
      module Canvas
        class Account < BaseType
          ...
          field :id, Int, "the ID of the Account object.Example: 2", null: true
          ...
          field :parent_account_id, Int, "The account's parent ID, or null if this is the root account.Example: 1", null: true
          field :root_account_id, Int, "The ID of the root account, or null if this is the root account.Example: 1", null: true
          ...
          field :sis_account_id, String, "The account's identifier in the Student Information System. Only included if the user has permission to view SIS information..Example: 123xyz", null: true
          field :integration_id, String, "The account's identifier in the Student Information System. Only included if the user has permission to view SIS information..Example: 123xyz", null: true
          field :sis_import_id, Int, "The id of the SIS import if created through SIS. Only included if the user has permission to manage SIS information..Example: 12", null: true
