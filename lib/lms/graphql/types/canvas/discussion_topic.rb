    ...
    module Types
      module Canvas
        ...
        class DiscussionTopic < BaseType
          ...
          field :id, Int, "The ID of this topic..Example: 1", null: true
          ...
          field :assignment_id, Int, "The unique identifier of the assignment if the topic is for grading, otherwise null..", null: true
          ...
          field :root_topic_id, Int, "If the topic is for grading and a group assignment this will point to the original topic in the course..", null: true
          ...
          field :group_category_id, Int, "The unique identifier of the group category if the topic is a group discussion, otherwise null..", null: true
