    ...
    module Types
      module Canvas
        class Profile < BaseType
          ...
          field :id, Int, "The ID of the user..Example: 1234", null: true
          ...
          field :login_id, String, "sample_user@example.com.Example: sample_user@example.com", null: true
          field :sis_user_id, String, "sis1.Example: sis1", null: true
          field :lti_user_id, String, "", null: true
