    ...
    module Types
      module Canvas
        class PollSession < BaseType
          ...
          field :id, Int, "The unique identifier for the poll session..Example: 1023", null: true
          field :poll_id, Int, "The id of the Poll this poll session is associated with.Example: 55", null: true
          field :course_id, Int, "The id of the Course this poll session is associated with.Example: 1111", null: true
          field :course_section_id, Int, "The id of the Course Section this poll session is associated with.Example: 444", null: true
