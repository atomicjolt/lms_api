    ...
    module Types
      module Canvas
        class PlannerOverride < BaseType
          ...
          field :id, Int, "The ID of the planner override.Example: 234", null: true
          field :plannable_type, String, "The type of the associated object for the planner override.Example: Assignment", null: true
          field :plannable_id, Int, "The id of the associated object for the planner override.Example: 1578941", null: true
          field :user_id, Int, "The id of the associated user for the planner override.Example: 1578941", null: true
