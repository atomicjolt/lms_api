...
module LMS
  module GraphQL
    module Types
      module Canvas
        class QuizExtension < BaseType
          description "Quiz Extensions. API Docs: https://canvas.instructure.com/doc/api/quiz_extensions.html"
          field :quiz_id, Int, "The ID of the Quiz the quiz extension belongs to..Example: 2", null: true
          field :user_id, Int, "The ID of the Student that needs the quiz extension..Example: 3", null: true
