    ...
    module Types
      module Canvas
        class CalendarEvent < BaseType
          ...
          field :id, Int, "The ID of the calendar event.Example: 234", null: true
          ...
          field :parent_event_id, Int, "Normally null. If this is a reservation (see the Appointment Groups API), the id will indicate the time slot it is for. If this is a section-level event, this will be the course-level parent event..", null: true
          ...
          field :appointment_group_id, Int, "Various Appointment-Group-related fields.These fields are only pertinent to time slots (appointments) and reservations of those time slots. See the Appointment Groups API. The id of the appointment group.", null: true
