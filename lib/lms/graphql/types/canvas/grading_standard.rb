    ...
    module Types
      module Canvas
        class GradingStandard < BaseType
          ...
          field :id, Int, "the id of the grading standard.Example: 1", null: true
          ...
          field :context_id, Int, "the id for the context either the Account or Course id.Example: 1", null: true
