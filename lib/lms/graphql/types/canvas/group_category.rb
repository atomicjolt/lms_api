    ...
    module Types
      module Canvas
        ...
        class GroupCategory < BaseType
          ...
          field :id, Int, "The ID of the group category..Example: 17", null: true
          ...
          field :account_id, Int, "Example: 3", null: true
          ...
          field :sis_group_category_id, String, "The SIS identifier for the group category. This field is only included if the user has permission to manage or view SIS information..", null: true
          field :sis_import_id, Int, "The unique identifier for the SIS import. This field is only included if the user has permission to manage SIS information..", null: true
