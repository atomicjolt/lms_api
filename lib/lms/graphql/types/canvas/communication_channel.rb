    ...
    module Types
      module Canvas
        ...
        class CommunicationChannel < BaseType
          ...
          field :id, Int, "The ID of the communication channel..Example: 16", null: true
          ...
          field :user_id, Int, "The ID of the user that owns this communication channel..Example: 1", null: true
