    ...
    module Types
      module Canvas
        class AssignmentOverride < BaseType
          ...
          field :student_ids, [ID], "the IDs of the override's target students (present if the override targets an ad-hoc set of students).Example: 1, 2, 3", null: true
          field :group_id, ID, "the ID of the override's target group (present if the override targets a group and the assignment is a group assignment).Example: 2", null: true
