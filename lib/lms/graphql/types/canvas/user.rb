    ...
    module Types
      module Canvas
        class User < BaseType
          ...
          field :id, Int, "The ID of the user..Example: 2", null: true
          ...
          field :sis_import_id, Int, "The id of the SIS import.  This field is only included if the user came from a SIS import and has permissions to manage SIS information..Example: 18", null: true
          field :integration_id, String, "The integration_id associated with the user.  This field is only included if the user came from a SIS import and has permissions to view SIS information..Example: ABC59802", null: true
          field :login_id, String, "The unique login id for the user.  This is what the user uses to log in to Canvas..Example: sheldon@caltech.example.com", null: true
