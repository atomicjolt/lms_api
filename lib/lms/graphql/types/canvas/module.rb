    ...
    module Types
      module Canvas
        ...
        class Module < BaseType
          ...
          field :id, Int, "the unique identifier for the module.Example: 123", null: true
          ...
          field :prerequisite_module_ids, Int, "IDs of Modules that must be completed before this one is unlocked.Example: 121, 122", null: true
