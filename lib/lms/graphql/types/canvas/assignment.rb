    ...
    module Types
      module Canvas
        ...
        class Assignment < BaseType
          ...
          field :id, Int, "the ID of the assignment.Example: 4", null: true
          ...
          field :course_id, Int, "the ID of the course the assignment belongs to.Example: 123", null: true
          ...
          field :assignment_group_id, Int, "the ID of the assignment's group.Example: 2", null: true
          ...
          field :group_category_id, Int, "The ID of the assignment’s group set, if this is a group assignment. For group discussions, set group_category_id on the discussion topic, not the linked assignment..Example: 1", null: true
          ...
          field :integration_id, String, "(optional, Third Party unique identifier for Assignment).Example: 12341234", null: true
          ...
          field :grading_standard_id, Int, "The id of the grading standard being applied to this assignment. Valid if grading_type is 'letter_grade' or 'gpa_scale'..", null: true
          ...
          field :quiz_id, Int, "(Optional) id of the associated quiz (applies only when submission_types is ['online_quiz']).Example: 620", null: true
