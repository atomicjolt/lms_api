    ...
    module Types
      module Canvas
        class PeerReview < BaseType
          ...
          field :assessor_id, Int, "The assessors user id.Example: 23", null: true
          field :asset_id, Int, "The id for the asset associated with this Peer Review.Example: 13", null: true
          field :asset_type, String, "The type of the asset.Example: Submission", null: true
          field :id, Int, "The id of the Peer Review.Example: 1", null: true
          field :user_id, Int, "The user id for the owner of the asset.Example: 7", null: true
