    ...
    module Types
      module Canvas
        class SubmissionVersion < BaseType
          ...
          field :grader_id, ID, "the user id of the user who graded this version of the submission.Example: 67379", null: true
          field :id, ID, "the id of the submission of which this is a version.Example: 11607", null: true
          ...
          field :user_id, ID, "the user ID of the student who created this submission.Example: 67376", null: true
