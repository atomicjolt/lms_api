...
module LMS
  module GraphQL
    module Mutations
      module Canvas
        class GradeOrCommentOnMultipleSubmissionsCoursesSubmission < CanvasBaseMutation
