    ...
    module Mutations
      module Canvas
        class CreateLinkOutcomeGlobal < CanvasBaseMutation
          ...
          def resolve(id:, outcome_id: nil, move_from: nil, title: nil, display_name: nil, description: nil, vendor_guid: nil, mastery_points: nil, ratings_description: nil, ratings_points: nil, calculation_method: nil, calculation_int: nil)
