    ...
    module Mutations
      module Canvas
        class CreateLinkOutcomeAccountsOutcomeId < CanvasBaseMutation
          ...
          def resolve(account_id:, id:, outcome_id:, move_from: nil, title: nil, display_name: nil, description: nil, vendor_guid: nil, mastery_points: nil, ratings_description: nil, ratings_points: nil, calculation_method: nil, calculation_int: nil)
            ctx[:canvas_api].proxy(
              "CREATE_LINK_OUTCOME_ACCOUNTS_OUTCOME_ID",
              {
