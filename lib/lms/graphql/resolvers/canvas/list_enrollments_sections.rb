...
module LMS
  module GraphQL
    module Resolvers
      module Canvas
        class ListEnrollmentsSection < CanvasBaseResolver
          ...
          def resolve(section_id:, type: nil, role: nil, state: nil, include: nil, user_id: nil, grading_period_id: nil, enrollment_term_id: nil, sis_account_id: nil, sis_course_id: nil, sis_section_id: nil, sis_user_id: nil)
